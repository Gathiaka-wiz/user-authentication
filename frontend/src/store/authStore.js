...
export const useAuthStore = create((set) => ({
    ...
    logout: async () => {
        ...
        try {
            ...
            set({ error:"Error Logging", isLoading:false });
            throw error;
        }
    ...
    verifyEmail: async (code) => {
        ...
        try {
            ...
            set({error:error.response.message || "Error verifying Email", isLoading:false});
            throw error;
        }
    },
    checkAuth: async () => {
    ...
    resetPassword: async ( token, password ) => {
        ...
        try {
            ...
            set({ message:response.data.message, isLoading:null });
        } catch (error) {
